...
<div class="min-h-screen bg-[#0f0f0f] pb-20">
    ...
    {:else}
      ...
      <div class="grid grid-cols-2 gap-3">
        <div class="bg-[#1a1a1a] rounded-xl p-4 text-center">
          <div class="text-2xl font-bold text-violet-400">{stats.totalDays}</div>
  ...
  <nav class="fixed bottom-0 left-0 right-0 bg-[#1a1a1a] border-t border-[#2a2a2a] px-4 py-2 safe-area-pb">
    <div class="max-w-lg mx-auto flex justify-around">
      ...
      <a href="/history" class="flex flex-col items-center py-2 px-4 text-gray-400 hover:text-violet-400">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <a href="/insights" class="flex flex-col items-center py-2 px-4 text-violet-400">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
